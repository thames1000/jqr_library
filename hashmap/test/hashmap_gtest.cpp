...
TEST(BaseTest, Insert_Func)
{
    ...
    hash_table_t *h_table = hash_table_init(20, NULL, print_string);
    exit_code_t ret_val = hash_insert(h_table, "15", temp);
    EXPECT_EQ(ret_val, E_SUCCESS);
...
TEST(BaseTest, Insert_Twice)
{
    ...
    void *temp = (void *)words;
    hash_table_t *h_table = hash_table_init(20, NULL, print_string);
    hash_insert(h_table, "15", temp);
    hash_insert(h_table, "22", temp);
...
TEST(BaseTest, Insert_Five)
{
    ...
    hash_table_t *h_table = hash_table_init(20, NULL, print_string);
    hash_insert(h_table, "15", temp);
    hash_insert(h_table, "Hello", temp);
    hash_insert(h_table, "22", temp);
    hash_insert(h_table, "America", temp);
    hash_insert(h_table, "99", temp);
